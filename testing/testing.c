...
int main(void) {
    ...
    printf("Assignment #1 testing completed!\n");
...
void test06_inputCString(void) {
    ...
    printf("%s (expected result: CANADA)\n", cstringValue);
    printf("////////////////////////////////////////\n\n");
}
...
void test07_inputCString(void) {
    ...
    printf("TEST #7: - Instructions:\n"
           "1) Enter the words 'Canada Ontario' [ENTER]\n"
...
ERROR: String length must be exactly 6 chars: CANADA
////////////////////////////////////////
TEST #6 RESULT: CANADA (expected result: CANADA)
////////////////////////////////////////
...
Assignment #1 testing completed!
*/
